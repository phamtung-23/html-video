...
const DICT = {
  vi: {
    ...
    'text_pane.tab_text': 'Văn bản',
    'text_pane.tab_narration': 'Thuyết minh',
    'text_pane.tab_exports': 'Video',
    'exports.loading': 'Đang tải danh sách video…',
    'exports.failed': 'Không tải được danh sách video.',
    'exports.empty': 'Chưa có video nào. Bấm "Xuất MP4" để tạo.',
    'exports.reveal': 'Mở trong Finder',
    'exports.delete': 'Xoá video này',
    'exports.delete_confirm': 'Xoá "{name}"? Không thể hoàn tác.',
    'exports.deleted': 'Đã xoá video',
    'exports.delete_failed': 'Xoá thất bại: {message}',
    ...
    'export.open_video': 'Mở tab Video',
    ...
    'soundtrack.group_frame': 'Kịch bản khung',
    'soundtrack.group_global': 'Toàn video',
    ...
    'soundtrack.captions': 'Phụ đề chạy chữ (hiện từng chữ theo giọng)',
    ...
    'soundtrack.voicegroup_vi_edge': 'Tiếng Việt — Edge (trực tuyến)',
    'soundtrack.voicegroup_vieneu': 'Tiếng Việt — VieNeu (ngoại tuyến, 14 giọng)',
    'soundtrack.voicegroup_en': 'English',
    'soundtrack.g_male': 'Nam',
    'soundtrack.g_female': 'Nữ',
    'soundtrack.r_bac': 'Miền Bắc',
    'soundtrack.r_trung': 'Miền Trung',
    'soundtrack.r_nam': 'Miền Nam',
    'soundtrack.voice_vi_female_edge': 'Tiếng Việt · Nữ (Edge, miễn phí)',
    'soundtrack.voice_vi_male_edge': 'Tiếng Việt · Nam (Edge, miễn phí)',
    'soundtrack.voice_en_us_male_guy': 'English (US) · Nam – Guy',
    'soundtrack.voice_en_us_male_christopher': 'English (US) · Nam – Christopher',
    'soundtrack.voice_en_us_male_eric': 'English (US) · Nam – Eric',
    'soundtrack.voice_en_us_female_aria': 'English (US) · Nữ – Aria',
    'soundtrack.voice_en_us_female_jenny': 'English (US) · Nữ – Jenny',
    'soundtrack.voice_en_gb_male_ryan': 'English (UK) · Nam – Ryan',
    'soundtrack.voice_en_gb_female_sonia': 'English (UK) · Nữ – Sonia',
    ...
    'soundtrack.narration_speed': 'Tốc độ',
    'soundtrack.clear': 'Xoá lời thoại',
    ...
    'settings.general.subtitle': 'Tùy chọn chung cho Studio — giao diện và ngôn ngữ.',
    'settings.theme.title': 'Giao diện',
    'settings.theme.subtitle': 'Chọn nền sáng, tối, hoặc theo hệ thống.',
    'settings.theme.auto': 'Tự động',
    'settings.theme.auto_sub': 'Theo hệ thống',
    'settings.theme.light': 'Sáng',
    'settings.theme.light_sub': 'Nền sáng',
    'settings.theme.dark': 'Tối',
    'settings.theme.dark_sub': 'Nền tối',
  ...
  en: {
    ...
    'chat.summary.confirm_edit': 'Edit',
    ...
    'text_pane.tab_text': 'Text',
    'text_pane.tab_narration': 'Narration',
    'text_pane.tab_exports': 'Videos',
    'exports.loading': 'Loading videos…',
    'exports.failed': 'Could not load the video list.',
    'exports.empty': 'No videos yet. Click "Export MP4" to create one.',
    'exports.reveal': 'Reveal in Finder',
    'exports.delete': 'Delete this video',
    'exports.delete_confirm': 'Delete "{name}"? This cannot be undone.',
    'exports.deleted': 'Video deleted',
    'exports.delete_failed': 'Delete failed: {message}',
    ...
    'export.open_video': 'Open Videos tab',
    ...
    'soundtrack.group_frame': 'Frame script',
    'soundtrack.group_global': 'Whole video',
    ...
    'soundtrack.captions': 'Word-by-word captions (appear with the voice)',
    ...
    'soundtrack.voicegroup_vi_edge': 'Vietnamese — Edge (online)',
    'soundtrack.voicegroup_vieneu': 'Vietnamese — VieNeu (offline, 14 voices)',
    'soundtrack.voicegroup_en': 'English',
    'soundtrack.g_male': 'Male',
    'soundtrack.g_female': 'Female',
    'soundtrack.r_bac': 'North',
    'soundtrack.r_trung': 'Central',
    'soundtrack.r_nam': 'South',
    'soundtrack.voice_vi_female_edge': 'Vietnamese · Female (Edge, free)',
    'soundtrack.voice_vi_male_edge': 'Vietnamese · Male (Edge, free)',
    'soundtrack.voice_en_us_male_guy': 'English (US) · Male – Guy',
    'soundtrack.voice_en_us_male_christopher': 'English (US) · Male – Christopher',
    'soundtrack.voice_en_us_male_eric': 'English (US) · Male – Eric',
    'soundtrack.voice_en_us_female_aria': 'English (US) · Female – Aria',
    'soundtrack.voice_en_us_female_jenny': 'English (US) · Female – Jenny',
    'soundtrack.voice_en_gb_male_ryan': 'English (UK) · Male – Ryan',
    'soundtrack.voice_en_gb_female_sonia': 'English (UK) · Female – Sonia',
    ...
    'soundtrack.narration_speed': 'Speed',
    'soundtrack.clear': 'Clear narration',
    ...
    'settings.general.subtitle': 'General Studio preferences — appearance and language.',
    'settings.theme.title': 'Appearance',
    'settings.theme.subtitle': 'Choose a light, dark, or system theme.',
    'settings.theme.auto': 'Auto',
    'settings.theme.auto_sub': 'Match system',
    'settings.theme.light': 'Light',
    'settings.theme.light_sub': 'Light background',
    'settings.theme.dark': 'Dark',
    'settings.theme.dark_sub': 'Dark background',
